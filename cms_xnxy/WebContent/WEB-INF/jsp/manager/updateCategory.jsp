...
<div class="editingarea">
	...
	<div class="c_editview">
		...
		<form action="updateCategory.action" method="post">
			<input type="hidden" name="id" value="${param.category_id }">
				...
				<div class="divtable mt5">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<c:forEach items="${categorys }" var="category" varStatus="state">
							<c:if test="${param.category_id==category.id }">
							<tr>
								<td class="tr" width="80">栏目名称：</td>
								<td class="pl5"><input type="text" name="name" value="${category.name }"></td>
							</tr>
							<tr>
								<td class="tr" width="80">栏目编号：</td>
								<td class="pl5"><input type="text" name="code" value="${category.code }"></td>
							</tr>
							</c:if>
						</c:forEach>
						</tbody>
